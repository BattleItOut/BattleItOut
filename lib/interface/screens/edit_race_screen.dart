...
class _EditRaceScreenState extends State<EditRaceScreen> {
  ...
  void initState() {
    ...
    attributes = (widget.race?.attributes.get() ?? GetIt.instance.get<AttributeRepository>().items)
  ...
  Widget build(BuildContext context) {
    ...
    return AsyncConsumer<SizeRepository>(
      builder: (SizeRepository repository) => Scaffold(
        appBar: AppBar(
          leading: IconButton(
